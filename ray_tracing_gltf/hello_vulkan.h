...
public:
  ...
  struct ComputeParams
  {
    ...
    // tone mapping
    nvvk::DescriptorSetBindings m_tonemapDescSetLayoutBind;
    vk::DescriptorPool          m_tonemapDescPool;
    vk::DescriptorSetLayout     m_tonemapDescSetLayout;
    vk::DescriptorSet           m_tonemapDescSet;
    vk::Pipeline                m_tonemapPipeline;
    vk::PipelineLayout          m_tonemapPipelineLayout;
